...
function ListController({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children });
}
function _extends() {
...
const Button = reactExports.forwardRef(
  ({ className, variant, size: size2, active = false, asChild = false, ...props }, ref) => {
    const Comp = asChild ? $5e63c961fc1ce211$export$8c6ed5c666ac1360 : "button";
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Comp,
      {
        className: cn(buttonVariants({ variant, size: size2, active, className })),
        ref,
        ...props
      }
    );
...
function FilterButton({ active, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "link", size: "sm", active, children });
}
...
const Separator = reactExports.forwardRef(({ className, decorative = true, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Filter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FilterButton, { children: "In Progress" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { orientation: "vertical" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FilterButton, { children: "Done" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { orientation: "vertical" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FilterButton, { children: "All" })
  ] });
}
function List({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children });
}
...
function AddButton({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "xs", onClick, children: "+ Tag" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverContent, { className: "w-48", align: "start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400", children: TAG_PREFIX }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "xs", onClick: onClickSubmit, children: "Add" })
    ] }) })
  ] });
}
...
function Item$1({ text, onClickDeleteButton }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm max-w-48 flex items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate-400", children: TAG_PREFIX }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: text }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        TooltipContent,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grow basis-0 break-all", children: text }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "icon",
...
function useStore$2(api, selector = identity, equalityFn) {
...
const createImpl = (createState) => {
  ...
  const useBoundStore = (selector, equalityFn) => useStore$2(api, selector, equalityFn);
...
function TagItem({ id: id2, onDelete }) {
  const text = useStore$1((state) => state.tags.get(id2)?.text);
  const deleteTag = useStore$1((state) => state.deleteTag);
  const handleClickDeleteButton = () => {
    deleteTag(id2);
    onDelete?.(id2);
  };
  return text ? /* @__PURE__ */ jsxRuntimeExports.jsx(Item$1, { text, onClickDeleteButton: handleClickDeleteButton }) : null;
}
...
function AddTag({ onAdd }) {
  ...
  const addTag = useStore$1((state) => state.addTag);
  const handleClick = () => {
    setOpened((prev) => !prev);
  };
...
const useStore = create()((set) => ({
  ...
  setCompleted: ({ id: id2, completed }) => set((state) => {
    const task = state.tasks.get(id2);
    if (!task) {
      return state;
    }
    return {
  ...
  prependTagId: ({ id: id2, tagId }) => set((state) => {
    const task = state.tasks.get(id2);
    if (!task) {
      return state;
    }
  ...
  deleteTagId: ({ id: id2, tagId }) => set((state) => {
    const task = state.tasks.get(id2);
    if (!task) {
      return state;
    }
    return {
      tasks: new Map(state.tasks).set(task.id, {
        ...task,
        tagIds: task.tagIds.filter((t2) => t2 !== tagId)
      })
    };
  })
}));
function Tags({ taskId }) {
  ...
  return tagIds.map((tagId) => /* @__PURE__ */ jsxRuntimeExports.jsx(TagItem, { id: tagId, onDelete: handleDelete }, tagId));
}
function Item({
  id: id2,
  text,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-rows-[min-content_1fr] grid-cols-[min-content_1fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex p-2 items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Checkbox, { checked, onCheckedChange: onChangeCheck }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-start-2 col-end-2 flex gap-2.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AddTag, { onAdd: onAddTag }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 flex-wrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tags, { taskId: id2 }) })
    ] })
  ] });
}
function TaskItem({ id: id2 }) {
  const task = useStore((state) => state.tasks.get(id2));
  ...
  const handleChangeCheck = (checked) => {
    setCompleted({ id: id2, completed: !!checked });
  };
  const handleChangeText = (e2) => {
    setText({ id: id2, text: e2.target.value });
  };
  const handleKeyDown = (e2) => {
    if (e2.key === "Backspace" && e2.currentTarget.value === "") {
      deleteTask(id2);
    }
  };
  const handleAddTag = (tagId) => {
    prependTagId({ id: id2, tagId });
  };
  return task ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    Item,
    {
      id: id2,
      text: task.text,
...
function Tasks() {
  ...
  return taskIds.map((id2) => /* @__PURE__ */ jsxRuntimeExports.jsx(TaskItem, { id: id2 }, id2));
}
function AddTask() {
  const addNewTask = useStore((state) => state.addNewTask);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", onClick: addNewTask, children: "+ Task" });
}
function App() {
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto my-16 flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ListController, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SearchInput, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AddTask, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Filter, {})
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(List, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tasks, {}) })
  ] }) });
}
